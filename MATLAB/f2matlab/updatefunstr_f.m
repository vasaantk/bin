function [funstr,funstrwords,funstrwords_b,funstrwords_e,funstrnumbers,funstrnumbers_b,funstrnumbers_e,s,fs_good,fs_goodHasAnyQuote]=updatefunstr_f(funstr,funstrwords,funstrwords_b,funstrwords_e,funstrnumbers,funstrnumbers_b,funstrnumbers_e,fs_good,oneline)
...
fs_goodHasAnyQuote=find(~cellfun('isempty',regexp(funstr,['[''"!%]'],'once')));
%fs_goodHasAnyQuote=intersect(fs_goodHasAnyQuote,fs_good);
temp1=zeros(1,s);
temp1(fs_goodHasAnyQuote)=1;
fs_goodHasAnyQuote=temp1;
