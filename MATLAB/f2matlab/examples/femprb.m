...
[writeErrFlag]=writeFmt(1,['%c'],'''FEMPRB''');
[writeErrFlag]=writeFmt(1,['%c'],'''  Begin FEMPACK tests.''');
test01;
...
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''FEMPRB''');
[writeErrFlag]=writeFmt(1,['%c'],'''  Normal end of FEMPACK tests.''');
%  stop
end
...
[writeErrFlag]=writeFmt(1,['%c'],'''  SHAPE_TEST tests the shape routines.''');
shape_test ( 'Q4' );
shape_test ( 'Q8' );
shape_test ( 'Q9' );
shape_test ( 'Q12' );
...
[writeErrFlag]=writeFmt(1,['%c'],'''  Test the grid routines.''');
grid_test ( 'Q4' );
grid_test ( 'Q8' );
grid_test ( 'Q9' );
grid_test ( 'Q12' );
...
[writeErrFlag]=writeFmt(1,['%c'],'''  Test the map routines.''');
map_test ( 'Q4' );
map_test ( 'Q8' );
map_test ( 'Q9' );
map_test ( 'Q12' );
...
[writeErrFlag]=writeFmt(1,['%c'],'''  DIV_BIL estimates divergence and vorticity.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c','%d','%c'],'''  Original U, V data forms ''','m',''' rows and ''');
[writeErrFlag]=writeFmt(1,['%c','%d','%c'],'''  ''','n',''' columns.''');
%
...
%
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''  I, J, X, Y, U(I,J), V(I,J)''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
for i = 1: m;
...
u(i,j) = x .* y;
v(i,j) = sin( x.^2 + y.^2 );
[writeErrFlag]=writeFmt(1,[repmat('%4d',1,2),repmat('%14.6g',1,4)],'i','j','x','y','u(i,j)','v(i, j)');
end; j = fix(n+1);
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
end; i = fix(m+1);
%
...
%
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''I, J, XM(I, j), YM(I, j)''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
for i = 1: m-1;
ym =( real(2.*m-2.*i-1) .* ylo + real(2.*i-1) .* yhi ) ./ real( 2 .* m - 2 );
for j = 1: n-1;
xm =( real(2.*n-2.*j-1) .* xlo + real(2.*j-1) .* xhi ) ./ real( 2 .* n - 2 );
[writeErrFlag]=writeFmt(1,[repmat('%4d',1,2),repmat('%14.6g',1,3)],'i','j','xm','ym');
end; j = fix(n-1+1);
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
end; i = fix(m-1+1);
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''  I, J, DIV(I, j), Exact Divergence, Difference''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
for i = 1: m - 1;
ym =( real(2.*m-2.*i-1) .* ylo + real(2.*i-1) .* yhi ) ./ real( 2 .* m - 2 );
for j = 1: n - 1;
...
temp = dudx + dvdy;
diff = div(i, j) - temp;
[writeErrFlag]=writeFmt(1,[repmat('%4d',1,2),repmat('%14.6g',1,3)],'i','j','div(i,j)','temp','diff');
end; j = fix(n - 1+1);
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
end; i = fix(m - 1+1);
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''  I, J, VORT(I, j), Exact Vorticity, Difference''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
for i = 1: m - 1;
...
temp = dvdx - dudy;
diff = vort(i, j) - temp;
[writeErrFlag]=writeFmt(1,[repmat('%4d',1,2),repmat('%14.6g',1,3)],'i','j','vort(i, j)','temp','diff');
end; j = fix(n-1+1);
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
end; i = fix(m - 1+1);
return;
...
%
function [dx11, dx12, dx21, dx22, dy11, dy12, dy21, dy22, psi11,psi12, psi21, psi22, xl, xm, xr, yb, ym, yt]=base_bil( dx11, dx12, dx21, dx22, dy11, dy12, dy21, dy22, psi11,psi12, psi21, psi22, xl, xm, xr, yb, ym, yt ,varargin);
%
%*******************************************************************************
%
...
function [div, m, maxm, n, u, v, vort, xhi, xlo, yhi, ylo]=div_bil( div, m, maxm, n, u, v, vort, xhi, xlo, yhi, ylo ,varargin);
%
%*******************************************************************************
%
...
if( m <= 1 );
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''DIV_BIL - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c'],'''  M must be at least 2,''');
[writeErrFlag]=writeFmt(1,['%c','%d'],'''  but the input value of M is ''','m');
warning(['stop encountered in original fortran code  ',char(10),';']);
div_orig(1:min(prod(div_shape),numel(div_orig)))=div(1:min(prod(div_shape),numel(div_orig)));div=div_orig;
u_orig(1:min(prod(u_shape),numel(u_orig)))=u(1:min(prod(u_shape),numel(u_orig)));u=u_orig;
v_orig(1:min(prod(v_shape),numel(v_orig)))=v(1:min(prod(v_shape),numel(v_orig)));v=v_orig;
vort_orig(1:min(prod(vort_shape),numel(vort_orig)))=vort(1:min(prod(vort_shape),numel(vort_orig)));vort=vort_orig;
return
end;
if( maxm < m );
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''DIV_BIL - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c'],'''  MAXM must be at least M,''');
[writeErrFlag]=writeFmt(1,['%c','%d'],'''  but the input value of MAXM is ''','maxm');
[writeErrFlag]=writeFmt(1,['%c','%d'],'''  and the input value of M is ''','m');
warning(['stop encountered in original fortran code  ',char(10),';']);
div_orig(1:min(prod(div_shape),numel(div_orig)))=div(1:min(prod(div_shape),numel(div_orig)));div=div_orig;
u_orig(1:min(prod(u_shape),numel(u_orig)))=u(1:min(prod(u_shape),numel(u_orig)));u=u_orig;
v_orig(1:min(prod(v_shape),numel(v_orig)))=v(1:min(prod(v_shape),numel(v_orig)));v=v_orig;
...
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''DIV_BIL - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c'],'''  N must be at least 2,''');
[writeErrFlag]=writeFmt(1,['%c','%d'],'''  but the input value of N is ''','n');
warning(['stop encountered in original fortran code  ',char(10),';']);
div_orig(1:min(prod(div_shape),numel(div_orig)))=div(1:min(prod(div_shape),numel(div_orig)));div=div_orig;
u_orig(1:min(prod(u_shape),numel(u_orig)))=u(1:min(prod(u_shape),numel(u_orig)));u=u_orig;
v_orig(1:min(prod(v_shape),numel(v_orig)))=v(1:min(prod(v_shape),numel(v_orig)));v=v_orig;
...
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''DIV_BIL - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c'],'''  XHI and XLO must be distinct,''');
[writeErrFlag]=writeFmt(1,['%c','%g'],'''  but the input value of XLO is ''','xlo');
[writeErrFlag]=writeFmt(1,['%c','%g'],'''  and the input value of XHI is ''','xhi');
warning(['stop encountered in original fortran code  ',char(10),';']);
div_orig(1:min(prod(div_shape),numel(div_orig)))=div(1:min(prod(div_shape),numel(div_orig)));div=div_orig;
u_orig(1:min(prod(u_shape),numel(u_orig)))=u(1:min(prod(u_shape),numel(u_orig)));u=u_orig;
v_orig(1:min(prod(v_shape),numel(v_orig)))=v(1:min(prod(v_shape),numel(v_orig)));v=v_orig;
...
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''DIV_BIL - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c'],'''  YHI and YLO must be distinct,''');
[writeErrFlag]=writeFmt(1,['%c','%g'],'''  but the input value of YLO is ''','ylo');
[writeErrFlag]=writeFmt(1,['%c','%g'],'''  and the input value of YHI is ''','yhi');
warning(['stop encountered in original fortran code  ',char(10),';']);
div_orig(1:min(prod(div_shape),numel(div_orig)))=div(1:min(prod(div_shape),numel(div_orig)));div=div_orig;
u_orig(1:min(prod(u_shape),numel(u_orig)))=u(1:min(prod(u_shape),numel(u_orig)));u=u_orig;
v_orig(1:min(prod(v_shape),numel(v_orig)))=v(1:min(prod(v_shape),numel(v_orig)));v=v_orig;
...
function [element_coderesult, i ]=element_code( i ,varargin);
%
%*******************************************************************************
%
...
%
if( i == 1 );
element_coderesult=strAssign(element_coderesult,[],[], 'Q4');
elseif( i == 2 ) ;
element_coderesult=strAssign(element_coderesult,[],[], 'Q8');
elseif( i == 3 ) ;
element_coderesult=strAssign(element_coderesult,[],[], 'Q9');
elseif( i == 4 ) ;
element_coderesult=strAssign(element_coderesult,[],[], 'Q12');
elseif( i == 5 ) ;
element_coderesult=strAssign(element_coderesult,[],[], 'Q16');
elseif( i == 6 ) ;
element_coderesult=strAssign(element_coderesult,[],[], 'QL');
elseif( i == 7 ) ;
element_coderesult=strAssign(element_coderesult,[],[], 'T3');
elseif( i == 8 ) ;
element_coderesult=strAssign(element_coderesult,[],[], 'T6');
elseif( i == 9 ) ;
element_coderesult=strAssign(element_coderesult,[],[], 'T10');
else;
element_coderesult=strAssign(element_coderesult,[],[], '????');
end;
csnil=dbstack(1); csnil=csnil(1).name(1)~='@';
if csnil&&~isempty(inputname(1)), assignin('caller','FUntemp',i); evalin('caller',[inputname(1),'=FUntemp;']); end
return;
end
function [order_coderesult, code ]=order_code( code ,varargin);
%
%*******************************************************************************
%
...
function [code, maxelem, n, nelemx, nelemy, nodes]=grid( code, maxelem, n, nelemx, nelemy, nodes ,varargin);
%
%*******************************************************************************
%
...
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''GRID - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c','%c'],'''  Illegal value of CODE = ''','code');
warning(['stop encountered in original fortran code  ',char(10),';']);
nodes_orig(1:min(prod(nodes_shape),numel(nodes_orig)))=nodes(1:min(prod(nodes_shape),numel(nodes_orig)));nodes=nodes_orig;
return
end;
nodes_orig(1:min(prod(nodes_shape),numel(nodes_orig)))=nodes(1:min(prod(nodes_shape),numel(nodes_orig)));nodes=nodes_orig;
return;
end
function [code]=grid_test( code ,varargin);
%
%*******************************************************************************
%
...
%
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''GRID_TEST''');
[writeErrFlag]=writeFmt(1,['%c','%c'],'''  Test the grid routine for element ''','code');
nelemx = 3;
nelemy = 2;
...
for ielem = 1: nelem;
[writeErrFlag]=writeFmt(1,['%3d','%3x',repmat('%3d',1,20)],'ielem',{'nodes((ielem-1).*n+i)','i','1','1','n'});
end; ielem = fix(nelem+1);
[ maxelem, n, nelem, nodes, width ]=grid_width( maxelem, n, nelem, nodes, width );
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c','%d'],'''Grid width is ''','width');
return;
end
function [maxelm, n, nelem, node, width]=grid_width( maxelm, n, nelem, node, width ,varargin);
%
%*******************************************************************************
%
...
node_orig(1:min(prod(node_shape),numel(node_orig)))=node(1:min(prod(node_shape),numel(node_orig)));node=node_orig;
return;
end
function [maxelem, nelemx, nelemy, nodes]=grid_q4( maxelem, nelemx, nelemy, nodes ,varargin);
%
%*******************************************************************************
%
...
if( nelem > maxelem );
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''GRID_Q4 - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c'],'''  Not enough storage for NODE array.''');
[writeErrFlag]=writeFmt(1,['%c','%d'],'''  Increase MAXELEM to ''','nelem');
warning(['stop encountered in original fortran code  ',char(10),';']);
nodes_orig(1:min(prod(nodes_shape),numel(nodes_orig)))=nodes(1:min(prod(nodes_shape),numel(nodes_orig)));nodes=nodes_orig;
return
end;
...
function [maxelem, nelemx, nelemy, nodes]=grid_q8( maxelem, nelemx, nelemy, nodes ,varargin);
%
%*******************************************************************************
%
...
if( nelem > maxelem );
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''GRID_Q8 - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c'],'''  Not enough storage for NODE array.''');
[writeErrFlag]=writeFmt(1,['%c','%d'],'''  Increase MAXELEM to ''','nelem');
warning(['stop encountered in original fortran code  ',char(10),';']);
nodes_orig(1:min(prod(nodes_shape),numel(nodes_orig)))=nodes(1:min(prod(nodes_shape),numel(nodes_orig)));nodes=nodes_orig;
...
function [maxelem, nelemx, nelemy, nodes]=grid_q9( maxelem, nelemx, nelemy, nodes ,varargin);
%
%*******************************************************************************
%
...
if( nelem > maxelem );
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''GRID_Q9 - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c'],'''  Not enough storage for NODE array.''');
[writeErrFlag]=writeFmt(1,['%c','%d'],'''  Increase MAXELEM to ''','nelem');
warning(['stop encountered in original fortran code  ',char(10),';']);
nodes_orig(1:min(prod(nodes_shape),numel(nodes_orig)))=nodes(1:min(prod(nodes_shape),numel(nodes_orig)));nodes=nodes_orig;
...
function [maxelem, nelemx, nelemy, nodes]=grid_q12( maxelem, nelemx, nelemy, nodes ,varargin);
%
%*******************************************************************************
%
...
if( nelem > maxelem );
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''GRID_Q12 - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c'],'''  Not enough storage for NODE array.''');
[writeErrFlag]=writeFmt(1,['%c','%d'],'''  Increase MAXELEM to ''','nelem');
warning(['stop encountered in original fortran code  ',char(10),';']);
nodes_orig(1:min(prod(nodes_shape),numel(nodes_orig)))=nodes(1:min(prod(nodes_shape),numel(nodes_orig)));nodes=nodes_orig;
...
function [maxelem, nelemx, nelemy, nodes]=grid_q16( maxelem, nelemx, nelemy, nodes ,varargin);
%
%*******************************************************************************
%
...
if( nelem > maxelem );
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''GRID_Q16 - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c'],'''  Not enough storage for NODE array.''');
[writeErrFlag]=writeFmt(1,['%c','%d'],'''  Increase MAXELEM to ''','nelem');
warning(['stop encountered in original fortran code  ',char(10),';']);
nodes_orig(1:min(prod(nodes_shape),numel(nodes_orig)))=nodes(1:min(prod(nodes_shape),numel(nodes_orig)));nodes=nodes_orig;
...
function [maxelem, nelemx, nelemy, nodes]=grid_ql( maxelem, nelemx, nelemy, nodes ,varargin);
%
%*******************************************************************************
%
...
if( nelem > maxelem );
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''GRID_QL - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c'],'''  Not enough storage for NODE array.''');
[writeErrFlag]=writeFmt(1,['%c','%d'],'''  Increase MAXELEM to ''','nelem');
warning(['stop encountered in original fortran code  ',char(10),';']);
nodes_orig(1:min(prod(nodes_shape),numel(nodes_orig)))=nodes(1:min(prod(nodes_shape),numel(nodes_orig)));nodes=nodes_orig;
...
function [maxelem, nelemx, nelemy, nodes]=grid_t3( maxelem, nelemx, nelemy, nodes ,varargin);
%
%*******************************************************************************
%
...
if( nelem > maxelem );
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''GRID_T3 - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c'],'''  Not enough storage for NODE array.''');
[writeErrFlag]=writeFmt(1,['%c','%d'],'''  Increase MAXELEM to ''','nelem');
warning(['stop encountered in original fortran code  ',char(10),';']);
nodes_orig(1:min(prod(nodes_shape),numel(nodes_orig)))=nodes(1:min(prod(nodes_shape),numel(nodes_orig)));nodes=nodes_orig;
...
function [maxelem, nelemx, nelemy, nodes]=grid_t6( maxelem, nelemx, nelemy, nodes ,varargin);
%
%*******************************************************************************
%
...
if( nelem > maxelem );
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''GRID_T6 - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c'],'''  Not enough storage for NODE array.''');
[writeErrFlag]=writeFmt(1,['%c','%d'],'''  Increase MAXELEM to ''','nelem');
warning(['stop encountered in original fortran code  ',char(10),';']);
nodes_orig(1:min(prod(nodes_shape),numel(nodes_orig)))=nodes(1:min(prod(nodes_shape),numel(nodes_orig)));nodes=nodes_orig;
...
function [maxelem, nelemx, nelemy, nodes]=grid_t10( maxelem, nelemx, nelemy, nodes ,varargin);
%
%*******************************************************************************
%
...
if( nelem > maxelem );
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''GRID_T10 - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c'],'''  Not enough storage for NODE array.''');
[writeErrFlag]=writeFmt(1,['%c','%d'],'''  Increase MAXELEM to ''','nelem');
warning(['stop encountered in original fortran code  ',char(10),';']);
nodes_orig(1:min(prod(nodes_shape),numel(nodes_orig)))=nodes(1:min(prod(nodes_shape),numel(nodes_orig)));nodes=nodes_orig;
...
function [code, dtdr, dtds, maxn, n, r, s, t, ubase, u, dudr, duds]=interp( code, dtdr, dtds, maxn, n, r, s, t, ubase, u, dudr, duds ,varargin);
%
%*******************************************************************************
%
...
function [code, w, lda, n]=map( code, w, lda, n ,varargin);
%
%*******************************************************************************
%
...
if( lda < n );
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''MAP - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c'],'''  LDA < N.''');
warning(['stop encountered in original fortran code  ',char(10),';']);
w_orig(1:min(prod(w_shape),numel(w_orig)))=w(1:min(prod(w_shape),numel(w_orig)));w=w_orig;
return
end;
if( maxn < n );
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''MAP - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c'],'''  Internal parameter MAXN exceeded.''');
[writeErrFlag]=writeFmt(1,['%c'],'''  MAXN < N.''');
warning(['stop encountered in original fortran code  ',char(10),';']);
w_orig(1:min(prod(w_shape),numel(w_orig)))=w(1:min(prod(w_shape),numel(w_orig)));w=w_orig;
return
end;
...
[writeErrFlag]=writeFmt(1,['%c'],'''-----------------------------------------------------------------------''');
[writeErrFlag]=writeFmt(1,['%g','%g'],'''w=''','w');
[writeErrFlag]=writeFmt(1,['%d','%d'],'''lda=''','lda');
[writeErrFlag]=writeFmt(1,['%d','%d'],'''n=''','n');
[writeErrFlag]=writeFmt(1,['%d','%d'],'''ipivot=''','ipivot');
[writeErrFlag]=writeFmt(1,['%d','%d'],'''info=''','info');
if( info ~= 0 );
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''MAP - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c'],'''  The Vandermonde matrix is singular.''');
warning(['stop encountered in original fortran code  ',char(10),';']);
w_orig(1:min(prod(w_shape),numel(w_orig)))=w(1:min(prod(w_shape),numel(w_orig)));w=w_orig;
return
end;
...
function [code]=map_test( code ,varargin);
%
%*******************************************************************************
%
...
%
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''MAP_TEST''');
[writeErrFlag]=writeFmt(1,['%c','%c'],'''  The interpolation matrix for element ''','code');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[n , code ]=order_code( code );
[ code, w, lda, n ]=map( code, w, lda, n );
for i = 1: n;
[writeErrFlag]=writeFmt(1,[repmat('%9.3f',1,7)],{'w(i,j)','j','1','1','n'});
end; i = fix(n+1);
return;
end
function [code, n, r, s, area]=node( code, n, r, s, area ,varargin);
%
%*******************************************************************************
%
...
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''NODE - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c','%c'],'''  Illegal value of CODE = ''','code');
warning(['stop encountered in original fortran code  ',char(10),';']);
...
function [n, r, s, area]=node_q4( n, r, s, area ,varargin);
%
%*******************************************************************************
%
...
function [n, r, s, area]=node_q8( n, r, s, area ,varargin);
%
%*******************************************************************************
%
...
function [n, r, s, area]=node_q9( n, r, s, area ,varargin);
%
%*******************************************************************************
%
...
function [n, r, s, area]=node_q12( n, r, s, area ,varargin);
%
%*******************************************************************************
%
...
function [n, r, s, area]=node_q16( n, r, s, area ,varargin);
%
%*******************************************************************************
%
...
function [n, r, s, area]=node_ql( n, r, s, area ,varargin);
%
%*******************************************************************************
%
...
function [n, r, s, area]=node_t3( n, r, s, area ,varargin);
%
%*******************************************************************************
%
...
function [n, r, s, area]=node_t6( n, r, s, area ,varargin);
%
%*******************************************************************************
%
...
function [n, r, s, area]=node_t10( n, r, s, area ,varargin);
%
%*******************************************************************************
%
...
function [code, n, rexp, sexp]=poly( code, n, rexp, sexp ,varargin);
%
%*******************************************************************************
%
...
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''POLY - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c','%c'],'''  Illegal value of CODE = ''','code');
warning(['stop encountered in original fortran code  ',char(10),';']);
...
function [n, rexp, sexp]=poly_q4( n, rexp, sexp ,varargin);
%
%*******************************************************************************
%
...
function [n, rexp, sexp]=poly_q8( n, rexp, sexp ,varargin);
%
%*******************************************************************************
%
...
function [n, rexp, sexp]=poly_q9( n, rexp, sexp ,varargin);
%
%*******************************************************************************
%
...
function [n, rexp, sexp]=poly_q12( n, rexp, sexp ,varargin);
%
%*******************************************************************************
%
...
function [n, rexp, sexp]=poly_q16( n, rexp, sexp ,varargin);
%
%*******************************************************************************
%
...
function [n, rexp, sexp]=poly_ql( n, rexp, sexp ,varargin);
%
%*******************************************************************************
%
...
function [n, rexp, sexp]=poly_t3( n, rexp, sexp ,varargin);
%
%*******************************************************************************
%
...
function [n, rexp, sexp]=poly_t6( n, rexp, sexp ,varargin);
%
%*******************************************************************************
%
...
function [n, rexp, sexp]=poly_t10( n, rexp, sexp ,varargin);
%
%*******************************************************************************
%
...
function [norder, xtab, weight]=quad_1d( norder, xtab, weight ,varargin);
%
%*******************************************************************************
%
...
if( norder < 1 );
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''QUAD1D - Fatal error!''');
...
function [nrule, maxorder, norder, area, rquad, squad, wquad]=quad_t( nrule, maxorder, norder, area, rquad, squad, wquad ,varargin);
%
%*******************************************************************************
%
...
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''QUADT - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c','%d'],'''  Unacceptable value of NRULE = ''','nrule');
warning(['stop encountered in original fortran code  ',char(10),';']);
return
end;
...
function [type, ve, vn, vne, vnw, vs, vse, vsw, vw, vterp]=serene( type, ve, vn, vne, vnw, vs, vse, vsw, vw, vterp ,varargin);
%
%*******************************************************************************
%
...
type=strAssign(repmat('A',1,2),[],[],type);
...
function [a, lda, n, ipivot, info]=sge_fa( a, lda, n, ipivot, info ,varargin);
%
%*******************************************************************************
%
...
function [a, lda, n, ipivot, work]=sge_inv( a, lda, n, ipivot, work ,varargin);
%
%*******************************************************************************
%
...
function [code, n, r, s, t, dtdr, dtds]=shape( code, n, r, s, t, dtdr, dtds ,varargin);
%
%*******************************************************************************
%
...
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''SHAPE - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c','%c'],'''  Unrecognized code = ''','code');
warning(['stop encountered in original fortran code  ',char(10),';']);
return
end;
return;
end
function [code]=shape_test( code ,varargin);
%
%*******************************************************************************
%
...
%
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''SHAPE_TEST''');
[writeErrFlag]=writeFmt(1,['%c','%c'],'''  Verify shape functions of type ''','code');
[ code, n, r, s, area ]=node( code, n, r, s, area );
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c','%d'],'''  Number of nodes = ''','n');
[writeErrFlag]=writeFmt(1,['%c'],'''  Basis function values at basis nodes''');
[writeErrFlag]=writeFmt(1,['%c'],'''  should form the identity matrix.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%*g'],'1.0./0.0');
for i = 1: n;
[ code, n, r(i), s(i), t, dtdr, dtds ]=shape( code, n, r(i), s(i), t, dtdr, dtds );
[writeErrFlag]=writeFmt(1,[repmat('%7.3f',1,10)],{'t(j)','j','1','1','n'});
end; i = fix(n+1);
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''  R and S derivatives should sum to 0.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''  dTdR sum, dTdS sum:''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
for i = 1: n;
[ code, n, r(i), s(i), t, dtdr, dtds ]=shape( code, n, r(i), s(i), t, dtdr, dtds );
rsum = 0.0;
...
[writeErrFlag]=writeFmt(1,[repmat('%14.8f',1,2)],'rsum','ssum');
end; i = fix(n+1);
return;
end
function [r, s, t, dtdr, dtds]=shape_q4( r, s, t, dtdr, dtds ,varargin);
%
%*******************************************************************************
%
...
function [r, s, t, dtdr, dtds]=shape_q8( r, s, t, dtdr, dtds ,varargin);
%
%*******************************************************************************
%
...
function [r, s, t, dtdr, dtds]=shape_q9( r, s, t, dtdr, dtds ,varargin);
%
%*******************************************************************************
%
...
function [r, s, t, dtdr, dtds]=shape_q12( r, s, t, dtdr, dtds ,varargin);
%
%*******************************************************************************
%
...
function [r, s, t, dtdr, dtds]=shape_q16( r, s, t, dtdr, dtds ,varargin);
%
%*******************************************************************************
%
...
function [r, s, t, dtdr, dtds]=shape_ql( r, s, t, dtdr, dtds ,varargin);
%
%*******************************************************************************
%
...
function [r, s, t, dtdr, dtds]=shape_t3( r, s, t, dtdr, dtds ,varargin);
%
%*******************************************************************************
%
...
function [r, s, t, dtdr, dtds]=shape_t6( r, s, t, dtdr, dtds ,varargin);
%
%*******************************************************************************
%
...
function [r, s, t, dtdr, dtds]=shape_t10( r, s, t, dtdr, dtds ,varargin);
%
%*******************************************************************************
%
