...
[writeErrFlag]=writeFmt(1,['%c'],'''QUADRULE_PRB''');
[writeErrFlag]=writeFmt(1,['%c'],'''  Test problems for the QUADRULE library.''');
test01;
test02;
test03;
test04;
...
%
%
persistent fname i ihi ilo maxfunc maxorder nfunc norder result weight xtab ; 

 if isempty(maxfunc), maxfunc = 20; end;
 if isempty(maxorder), maxorder = 8; end;
%
%this works around matlab evalin bug in writeFmt
 if isempty(fname), fname=repmat(' ',1,11); end;
%  character ( len = 10 ), external :: fname !use this for original intent
...
[writeErrFlag]=writeFmt(1,['%c'],'''  BASHFORTH_SET sets up Adams-Bashforth quadrature;''');
[writeErrFlag]=writeFmt(1,['%c'],'''  SUMMER carries it out.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''  Integration interval is [0,1].''');
[writeErrFlag]=writeFmt(1,['%c'],'''  Quadrature order will vary.''');
[writeErrFlag]=writeFmt(1,['%c'],'''  Integrand will vary.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
for ilo = 1: 5: nfunc;
ihi = fix(min( ilo + 4, nfunc ));
[writeErrFlag]=writeFmt(1,['%d','%d'],'''ilo=''','ilo');
[writeErrFlag]=writeFmt(1,['%d','%d'],'''ihi=''','ihi');
[writeErrFlag]=writeFmt(1,['%d','%d'],'''nfunc=''','nfunc');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%4x',repmat('%14c',1,5)],{'fname(i)','i','ilo','1','ihi'});
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
...
[writeErrFlag]=writeFmt(1,['%2d','%2x',repmat('%14.8f',1,5)],'norder','result([ilo:ihi])');
...
%
%
persistent diftab fname i ihi ilo maxfunc maxorder nfunc norder result weight xtab ; 
...
[writeErrFlag]=writeFmt(1,['%c'],'''  BDFC_SET sets up Backward Difference Corrector quadrature;''');
[writeErrFlag]=writeFmt(1,['%c'],'''  BDF_SUM carries it out.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''  Integration interval is [0,1].''');
[writeErrFlag]=writeFmt(1,['%c'],'''  Quadrature order will vary.''');
[writeErrFlag]=writeFmt(1,['%c'],'''  Integrand will vary.''');
...
[writeErrFlag]=writeFmt(1,['%c'],'''  BDFP_SET sets up Backward Difference Predictor quadrature;''');
[writeErrFlag]=writeFmt(1,['%c'],'''  BDF_SUM carries it out.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''  Integration interval is [0,1].''');
[writeErrFlag]=writeFmt(1,['%c'],'''  Quadrature order will vary.''');
...
%
%
persistent a b fname i ihi ilo maxfunc maxorder nfunc norder nsub result weight xhi xlo xtab ; 
...
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''TEST04''');
[writeErrFlag]=writeFmt(1,['%c'],'''  CHEB_SET sets up Chebyshev quadrature;''');
[writeErrFlag]=writeFmt(1,['%c'],'''  SUM_SUB carries it out.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''  The integration interval is ''','a','b');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Number of subintervals is ''','nsub');
[writeErrFlag]=writeFmt(1,['%c'],'''  Quadrature order will vary.''');
[writeErrFlag]=writeFmt(1,['%c'],'''  Integrand will vary.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
for ilo = 1: 5: nfunc;
...
%
%
persistent a b fname i ihi ilo maxfunc maxorder nfunc norder nsub result weight xtab ; 
...
[writeErrFlag]=writeFmt(1,['%c'],'''  CHEB_TC_SET sets up Gauss-Chebyshev quadrature,''');
[writeErrFlag]=writeFmt(1,['%c'],'''  ( closed, first kind );''');
[writeErrFlag]=writeFmt(1,['%c'],'''  SUMMER carries it out.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c',repmat('%14.6g',1,2)],'''  Integration interval is ''','a','b');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Number of subintervals is ''','nsub');
[writeErrFlag]=writeFmt(1,['%c'],'''  Quadrature order will vary.''');
[writeErrFlag]=writeFmt(1,['%c'],'''  Integrand will vary.''');
[writeErrFlag]=writeFmt(1,['%c'],'''  The weight function is 1 / sqrt ( 1 - X**2 )''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
for ilo = 1: 5: nfunc;
ihi = fix(min( ilo + 4, nfunc ));
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
...
[writeErrFlag]=writeFmt(1,['%c'],'''  CHEB_TO_SET sets up Gauss-Chebyshev quadrature,''');
[writeErrFlag]=writeFmt(1,['%c'],'''  ( open, first kind );''');
[writeErrFlag]=writeFmt(1,['%c'],'''  SUMMER carries it out.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c',repmat('%14.6g',1,2)],'''  Integration interval is ''','a','b');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Number of subintervals is ''','nsub');
...
[writeErrFlag]=writeFmt(1,['%c'],'''  CHEB_U_SET sets up Gauss-Chebyshev quadrature;''');
[writeErrFlag]=writeFmt(1,['%c'],'''  SUMMER carries it out.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c',repmat('%14.6g',1,2)],'''  Integration interval is ''','a','b');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Number of subintervals is ''','nsub');
[writeErrFlag]=writeFmt(1,['%c'],'''  Quadrature order will vary.''');
[writeErrFlag]=writeFmt(1,['%c'],'''  Integrand will vary.''');
[writeErrFlag]=writeFmt(1,['%c'],'''  The weight function is sqrt ( 1 - X**2 )''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
for ilo = 1: 5: nfunc;
ihi = fix(min( ilo + 4, nfunc ));
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
...
[writeErrFlag]=writeFmt(1,['%c'],'''  HERMITE_COM computes a Gauss-Hermite rule;''');
[writeErrFlag]=writeFmt(1,['%c'],'''  SUMMER carries it out.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''  The integration interval is ( -Infinity, +Infinity ).''');
for ilo = 1: 5: nfunc;
ihi = fix(min( ilo + 4, nfunc ));
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%4x',repmat('%14c',1,5)],{'fname(i)','i','ilo','1','ihi'});
...
[writeErrFlag]=writeFmt(1,['%c'],'''  HERMITE_SET sets up Gauss-Hermite quadrature;''');
[writeErrFlag]=writeFmt(1,['%c'],'''  SUMMER carries it out.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''  The integration interval is ( -Infinity, +Infinity ).''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
...
%
%
persistent a alpha_ml b beta fname i ihi ilo k maxfunc maxorder nfunc norder nsub result weight xhi xlo xtab ; 
...
[writeErrFlag]=writeFmt(1,['%c'],'''  JACOBI_COM sets up Gauss-Jacobi quadrature;''');
[writeErrFlag]=writeFmt(1,['%c'],'''  SUM_SUB carries it out.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c',repmat('%14.6g',1,2)],'''  The integration interval is ''','a','b');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Number of subintervals is ''','nsub');
[writeErrFlag]=writeFmt(1,['%c'],'''  Quadrature order will vary.''');
[writeErrFlag]=writeFmt(1,['%c'],'''  Integrand will vary.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
...
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c','%14.6g'],'''  ALPHA = ''','alpha_ml');
[writeErrFlag]=writeFmt(1,['%c','%14.6g'],'''  BETA =  ''','beta');
for ilo = 1: 5: nfunc;
ihi = fix(min( ilo + 4, nfunc ));
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%4x',repmat('%14c',1,5)],{'fname(i)','i','ilo','1','ihi'});
...
for i = ilo: ihi;
[dumvar1, i ]=func_set ( 'SET', i );
[ norder, xtab, weight, alpha_ml, beta ]=jacobi_com( norder, xtab, weight, alpha_ml, beta );
[dumvar1, a, b, nsub, norder, xlo, xhi, xtab, weight,result(i) ]=sum_sub( @func, a, b, nsub, norder, xlo, xhi, xtab, weight,result(i) );
end; i = fix(ihi+1);
[writeErrFlag]=writeFmt(1,['%2d','%2x',repmat('%14.8f',1,5)],'norder','result([ilo:ihi])');
end; norder = fix(maxorder+1);
...
[writeErrFlag]=writeFmt(1,['%c'],'''  KRONROD_SET sets up Kronrod quadrature;''');
[writeErrFlag]=writeFmt(1,['%c'],'''  LEGENDRE_SET sets up Gauss-Legendre quadrature;''');
[writeErrFlag]=writeFmt(1,['%c'],'''  SUMMER_GK carries it out.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''  Integration interval is [-1, 1].''');
[writeErrFlag]=writeFmt(1,['%c'],'''  Integrand is X**2 / SQRT ( 1.1 - X**2 ).''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
...
[writeErrFlag]=writeFmt(1,['%2d','%2x','%16.10g'],'norderg','resultg');
[writeErrFlag]=writeFmt(1,['%2d','%2x','%16.10g'],'norderk','resultk');
[writeErrFlag]=writeFmt(1,['%2x','%2x','%16.10g'],'resultg-resultk');
return;
end
...
[writeErrFlag]=writeFmt(1,['%c'],'''  KRONROD_SET sets up Kronrod quadrature;''');
[writeErrFlag]=writeFmt(1,['%c'],'''  LEGENDRE_SET sets up Gauss-Legendre quadrature;''');
[writeErrFlag]=writeFmt(1,['%c'],'''  SUM_SUB_GK carries it out.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c',repmat('%14.6g',1,2)],'''  Integration interval is ''','a','b');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Number of subintervals is ''','nsub');
[writeErrFlag]=writeFmt(1,['%c'],'''  Integrand is X**2 / SQRT ( 1.1 - X**2 ).''');
...
[writeErrFlag]=writeFmt(1,['%2d','%2x','%16.10g'],'norderg','resultg');
[writeErrFlag]=writeFmt(1,['%2d','%2x','%16.10g'],'norderk','resultk');
[writeErrFlag]=writeFmt(1,['%2x','%2x','%16.10g'],'error');
return;
end
...
%
%
persistent a alpha_ml fname i ihi ii ilo maxfunc maxorder nfunc norder result weight xtab ; 
...
[writeErrFlag]=writeFmt(1,['%c'],'''  LAGUERRE_COM computes a Gauss-Laguerre rule;''');
[writeErrFlag]=writeFmt(1,['%c'],'''  LAGUERRE_SUM carries it out.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''  Quadrature order will vary.''');
[writeErrFlag]=writeFmt(1,['%c'],'''  Integrand will vary.''');
[writeErrFlag]=writeFmt(1,['%c'],'''  The weight function is EXP ( - X ).''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
%
a = 1.0d+00;
alpha_ml = 0.0d+00;
[writeErrFlag]=writeFmt(1,['%c','%14.6g','%c'],'''  The integration interval is [ ''','a',''', +Infinity ).''');
[writeErrFlag]=writeFmt(1,['%c','%14.6g'],'''  ALPHA = ''','alpha_ml');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
for ilo = 1: 5: nfunc;
ihi = fix(min( ilo + 4, nfunc ));
...
for i = ilo: ihi;
[dumvar1, i ]=func_set ( 'SET', i );
[ norder, xtab, weight, alpha_ml ]=laguerre_com( norder, xtab, weight, alpha_ml );
...
[writeErrFlag]=writeFmt(1,['%2d','%2x',repmat('%14.6g',1,5)],'norder','result([ilo:ihi])');
...
%
%
persistent a fname i ihi ilo maxfunc maxorder nfunc norder result weight xtab ; 
...
[writeErrFlag]=writeFmt(1,['%c'],'''  LAGUERRE_SET sets up Gauss-Laguerre quadrature;''');
[writeErrFlag]=writeFmt(1,['%c'],'''  LAGUERRE_SUM carries it out.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c','%14.6g','%c'],'''  The integration interval is [ ''','a',''', +Infinity ).''');
[writeErrFlag]=writeFmt(1,['%c'],'''  Quadrature order will vary.''');
...
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''TEST16''');
[writeErrFlag]=writeFmt(1,['%c'],'''  LEGENDRE_COM computes Gauss-Legendre data;''');
[writeErrFlag]=writeFmt(1,['%c'],'''  LEGENDRE_SET looks up the same data.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Compare the data for NORDER = ''','norder');
...
if( ixdifmax ~= 0 );
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c','%25.18g'],'''  Maximum abscissa difference is ''','xdifmax');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  for index I = ''','ixdifmax');
[writeErrFlag]=writeFmt(1,['%c','%25.18g'],'''Computed:''','xtab1(ixdifmax)');
[writeErrFlag]=writeFmt(1,['%c','%25.18g'],'''Stored:  ''','xtab2(ixdifmax)');
else;
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''  The computed and stored abscissas are identical.''');
end;
if( iwdifmax ~= 0 );
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c','%25.18g'],'''  Maximum weight difference is   ''','wdifmax');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  for index I = ''','iwdifmax');
[writeErrFlag]=writeFmt(1,['%c','%25.18g'],'''Computed:''','weight1(iwdifmax)');
[writeErrFlag]=writeFmt(1,['%c','%25.18g'],'''Stored:  ''','weight2(iwdifmax)');
else;
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''  The computed and stored weights are identical.''');
end;
...
[writeErrFlag]=writeFmt(1,['%c'],'''  LEGENDRE_COM computes a Gauss-Legendre rule;''');
[writeErrFlag]=writeFmt(1,['%c'],'''  SUM_SUB carries it out over subintervals.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c',repmat('%14.6g',1,2)],'''  The integration interval is ''','a','b');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Here, we use a fixed order NORDER = ''','norder');
[writeErrFlag]=writeFmt(1,['%c'],'''  and use more and more subintervals.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''  NSUB     Integral''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
...
[writeErrFlag]=writeFmt(1,['%4d','%16.8g'],'nsub','result');
end; iexp = fix(9+1);
...
[writeErrFlag]=writeFmt(1,['%c'],'''  LEGENDRE_COM sets up Gauss-Legendre quadrature;''');
[writeErrFlag]=writeFmt(1,['%c'],'''  SUM_SUB carries it out.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c',repmat('%14.6g',1,2)],'''  The integration interval is ''','a','b');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Number of subintervals is ''','nsub');
...
[writeErrFlag]=writeFmt(1,['%c'],'''  LEGENDRE_SET sets up Gauss-Legendre quadrature''');
[writeErrFlag]=writeFmt(1,['%c'],'''    for integrating F(X) over [-1,1];''');
[writeErrFlag]=writeFmt(1,['%c'],'''  RULE_ADJUST adjusts a rule for a new interval.''');
[writeErrFlag]=writeFmt(1,['%c'],'''  LEGENDRE_SET_X0_01 sets up Gauss-Legendre quadrature''');
[writeErrFlag]=writeFmt(1,['%c'],'''    for integrating F(X) over [0,1];''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''  We will use LEGENDRE_SET to get a rule for [-1,1],''');
[writeErrFlag]=writeFmt(1,['%c'],'''  adjust it to [0,1] using RULE_ADJUST,''');
[writeErrFlag]=writeFmt(1,['%c'],'''  and compare the results of LEGENDRE_SET_X0_01.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
...
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''  Abscissas:''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''  Original  Adjusted Stored''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
for i = 1: norder;
[writeErrFlag]=writeFmt(1,['%2d',repmat('%16.12f',1,3)],'i','xtab1(i)','xtab2(i)','xtab3(i)');
end; i = fix(norder+1);
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''  Weights:''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''  Original  Adjusted Stored''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
for i = 1: norder;
[writeErrFlag]=writeFmt(1,['%2d',repmat('%16.12f',1,3)],'i','weight1(i)','weight2(i)','weight3(i)');
end; i = fix(norder+1);
return;
end
...
%
%
persistent a b fname i iexp ihi ilo maxfunc maxorder nfunc norder nsub result weight xhi xlo xtab ; 
...
[writeErrFlag]=writeFmt(1,['%c'],'''  LEGENDRE_SET_COS sets up Gauss-Legendre quadrature''');
[writeErrFlag]=writeFmt(1,['%c'],'''    over [-PI/2,PI/2] with weight function COS(X);''');
[writeErrFlag]=writeFmt(1,['%c'],'''  SUM_SUB carries it out.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c',repmat('%14.6g',1,2)],'''  The integration interval is ''','a','b');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Number of subintervals is ''','nsub');
...
xhi = 1.0d+00;
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''TEST235''');
[writeErrFlag]=writeFmt(1,['%c'],'''  LEGENDRE_SET_SQRTX_01 sets up Gauss-Legendre quadrature''');
[writeErrFlag]=writeFmt(1,['%c'],'''    over [0,1] with weight function SQRT(X);''');
[writeErrFlag]=writeFmt(1,['%c'],'''  SUM_SUB carries it out.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c',repmat('%14.6g',1,2)],'''  The integration interval is ''','a','b');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Number of subintervals is ''','nsub');
...
xhi = 1.0d+00;
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''TEST236''');
[writeErrFlag]=writeFmt(1,['%c'],'''  LEGENDRE_SET_SQRTX2_01 sets up Gauss-Legendre''');
[writeErrFlag]=writeFmt(1,['%c'],'''    quadrature over [0,1] with weight function 1/SQRT(X);''');
[writeErrFlag]=writeFmt(1,['%c'],'''  SUM_SUB carries it out.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c',repmat('%14.6g',1,2)],'''  The integration interval is ''','a','b');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Number of subintervals is ''','nsub');
...
[writeErrFlag]=writeFmt(1,['%c'],'''  LEGENDRE_SET_COS2 sets up Gauss-Legendre quadrature''');
[writeErrFlag]=writeFmt(1,['%c'],'''    over [0,PI/2] with weight function COS(X);''');
[writeErrFlag]=writeFmt(1,['%c'],'''  SUM_SUB carries it out.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c',repmat('%14.6g',1,2)],'''  The integration interval is ''','a','b');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Number of subintervals is ''','nsub');
...
%
%
persistent a b fname i iexp ihi ilo itest maxfunc maxorder nfunc norder norder_test nsub ntest result weight xhi xlo xtab ; 
...
[writeErrFlag]=writeFmt(1,['%c'],'''  LEGENDRE_SET_LOG sets up Gauss-Legendre quadrature''');
[writeErrFlag]=writeFmt(1,['%c'],'''    over [0,1] with weight function -LOG(X);''');
[writeErrFlag]=writeFmt(1,['%c'],'''  SUM_SUB carries it out.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c',repmat('%14.6g',1,2)],'''  The integration interval is ''','a','b');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Number of subintervals is ''','nsub');
...
[writeErrFlag]=writeFmt(1,['%c'],'''  LEGENDRE_SET_X1 sets up Gauss-Legendre quadrature''');
[writeErrFlag]=writeFmt(1,['%c'],'''    for integrating ( 1 + X ) * F(X) over [-1,1];''');
[writeErrFlag]=writeFmt(1,['%c'],'''  SUM_SUB carries it out.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c',repmat('%14.6g',1,2)],'''  The integration interval is ''','a','b');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Number of subintervals is ''','nsub');
...
[writeErrFlag]=writeFmt(1,['%c'],'''    for integrating ( 1 + X ) * F(X) over [-1,1];''');
[writeErrFlag]=writeFmt(1,['%c'],'''  RULE_ADJUST adjusts a rule for a new interval.''');
[writeErrFlag]=writeFmt(1,['%c'],'''  LEGENDRE_SET_X1_01 sets up Gauss-Legendre quadrature''');
[writeErrFlag]=writeFmt(1,['%c'],'''    for integrating X * F(X) over [0,1];''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''  We will use LEGENDRE_SET_X1 to get a rule for [-1,1],''');
[writeErrFlag]=writeFmt(1,['%c'],'''  adjust it to [0,1] using RULE_ADJUST,''');
[writeErrFlag]=writeFmt(1,['%c'],'''  make further adjustments because the weight function''');
[writeErrFlag]=writeFmt(1,['%c'],'''  is not 1, ''');
[writeErrFlag]=writeFmt(1,['%c'],'''  and compare the results of LEGENDRE_SET_X1_01.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
...
[writeErrFlag]=writeFmt(1,['%c'],'''  LEGENDRE_SET_X2 sets up Gauss-Legendre quadrature''');
[writeErrFlag]=writeFmt(1,['%c'],'''    for integrating (1+X)**2 * F(X) over [-1,1];''');
[writeErrFlag]=writeFmt(1,['%c'],'''  SUM_SUB carries it out.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c',repmat('%14.6g',1,2)],'''  The integration interval is ''','a','b');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Number of subintervals is ''','nsub');
...
[writeErrFlag]=writeFmt(1,['%c'],'''    for integrating ( 1 + X )^2 * F(X) over [-1,1];''');
[writeErrFlag]=writeFmt(1,['%c'],'''  RULE_ADJUST adjusts a rule for a new interval.''');
[writeErrFlag]=writeFmt(1,['%c'],'''  LEGENDRE_SET_X2_01 sets up Gauss-Legendre quadrature''');
[writeErrFlag]=writeFmt(1,['%c'],'''    for integrating X^2 * F(X) over [0,1];''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''  We will use LEGENDRE_SET_X2 to get a rule for [-1,1],''');
[writeErrFlag]=writeFmt(1,['%c'],'''  adjust it to [0,1] using RULE_ADJUST,''');
[writeErrFlag]=writeFmt(1,['%c'],'''  make further adjustments because the weight function''');
[writeErrFlag]=writeFmt(1,['%c'],'''  is not 1, ''');
[writeErrFlag]=writeFmt(1,['%c'],'''  and compare the results of LEGENDRE_SET_X2_01.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
...
[writeErrFlag]=writeFmt(1,['%c'],'''  LEGENDRE_SET_X2_01 sets up Gauss-Legendre quadrature''');
[writeErrFlag]=writeFmt(1,['%c'],'''    for integrating X*X * F(X) over [0,1];''');
[writeErrFlag]=writeFmt(1,['%c'],'''  SUM_SUB carries it out.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c',repmat('%14.6g',1,2)],'''  The integration interval is ''','a','b');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Number of subintervals is ''','nsub');
...
[writeErrFlag]=writeFmt(1,['%c'],'''  LOBATTO_SET sets up Lobatto quadrature;''');
[writeErrFlag]=writeFmt(1,['%c'],'''  SUM_SUB carries it out.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c',repmat('%14.6g',1,2)],'''  Integration interval is ''','a','b');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Number of subintervals is ''','nsub');
...
[dumvar1, nfunc ]=func_set ( 'COUNT', nfunc );
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''TEST34''');
[writeErrFlag]=writeFmt(1,['%c'],'''  MOULTON_SET sets up Adams-Moulton quadrature;''');
[writeErrFlag]=writeFmt(1,['%c'],'''  SUMMER carries it out.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''  Integration interval is [0,1].''');
[writeErrFlag]=writeFmt(1,['%c'],'''  Quadrature order will vary.''');
...
xhi = +1.0d+00;
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''TEST35''');
[writeErrFlag]=writeFmt(1,['%c'],'''  NCC_SET sets up a closed Newton Cotes rule;''');
[writeErrFlag]=writeFmt(1,['%c'],'''  SUM_SUB carries it out.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c',repmat('%14.6g',1,2)],'''  Integration interval is ''','a','b');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Number of subintervals is ''','nsub');
...
xhi = +1.0d+00;
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''TEST36''');
[writeErrFlag]=writeFmt(1,['%c'],'''  NCC_COM computes a closed Newton Cotes rule;''');
[writeErrFlag]=writeFmt(1,['%c'],'''  SUM_SUB carries it out.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c',repmat('%14.6g',1,2)],'''  Integration interval is ''','a','b');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Number of subintervals is ''','nsub');
...
xhi = +1.0d+00;
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''TEST37''');
[writeErrFlag]=writeFmt(1,['%c'],'''  NCO_SET sets up an open Newton-Cotes rule;''');
[writeErrFlag]=writeFmt(1,['%c'],'''  SUM_SUB carries it out.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c',repmat('%14.6g',1,2)],'''  Integration interval is ''','a','b');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Number of subintervals is ''','nsub');
...
xhi = +1.0d+00;
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''TEST38''');
[writeErrFlag]=writeFmt(1,['%c'],'''  NCO_COM sets up an open Newton-Cotes rule;''');
[writeErrFlag]=writeFmt(1,['%c'],'''  SUM_SUB carries it out.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c',repmat('%14.6g',1,2)],'''  Integration interval is ''','a','b');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Number of subintervals is ''','nsub');
...
xhi = +1.0d+00;
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''TEST39''');
[writeErrFlag]=writeFmt(1,['%c'],'''  RADAU_SET sets up Radau quadrature;''');
[writeErrFlag]=writeFmt(1,['%c'],'''  SUM_SUB carries it out.''');
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c',repmat('%14.6g',1,2)],'''  The integration interval is ''','a','b');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Number of subintervals is ''','nsub');
...
function [f1sd1result, x ]=f1sd1( x ,varargin);
%
%*******************************************************************************
%
...
function [fxsd1result, x ]=fxsd1( x ,varargin);
%
%*******************************************************************************
%
...
function [fx2sd1result, x ]=fx2sd1( x ,varargin);
%
%*******************************************************************************
%
...
function [funcresult, x ]=func( x ,varargin);
%
%*******************************************************************************
%
...
function [action, i]=func_set( action, i ,varargin);
%
%*******************************************************************************
%
...
%
%    Output, character ( len = 11 ) FNAME, the name of the function.
%
%
fnameresult=[];
persistent fname ; 

 if isempty(fnameresult), fnameresult=repmat(' ',1,11); end;
%
if( ifunc == 1 );
...
function [norder, xtab, weight]=bashforth_set( norder, xtab, weight ,varargin);
%*******************************************************************************
%
...
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''BASHFORTH_SET - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Illegal value of NORDER = ''','norder');
[writeErrFlag]=writeFmt(1,['%c'],'''  Legal values are 1 through 8.''');
...
function [norder, alpha_ml, beta, gamma]=bdf_set( norder, alpha_ml, beta, gamma ,varargin);
%*******************************************************************************
%
...
beta =        60.0d+00;
gamma =      137.0d+00;
alpha_ml(1) =   300.0d+00;
alpha_ml(2) = - 300.0d+00;
alpha_ml(3) =   200.0d+00;
alpha_ml(4) =  - 75.0d+00;
alpha_ml(5) =    12.0d+00;
elseif( norder == 6 ) ;
beta =        60.0d+00;
gamma =      147.0d+00;
alpha_ml(1) =   360.0d+00;
alpha_ml(2) = - 450.0d+00;
alpha_ml(3) =   400.0d+00;
alpha_ml(4) = - 225.0d+00;
alpha_ml(5) =    72.0d+00;
alpha_ml(6) =  - 10.0d+00;
else;
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''BDF_SET - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Illegal order requested = ''','norder');
warning(['stop encountered in original fortran code  ',char(10),';']);
return
end;
return;
end
function [norder, weight, xtab]=bdfc_set( norder, weight, xtab ,varargin);
%*******************************************************************************
%
...
function [norder, weight, xtab]=bdfp_set( norder, weight, xtab ,varargin);
%*******************************************************************************
%
...
function [func, norder, weight, xtab, diftab, result]=bdf_sum( func, norder, weight, xtab, diftab, result ,varargin);
%*******************************************************************************
%
...
function [norder, xtab, weight]=cheb_set( norder, xtab, weight ,varargin);
%*******************************************************************************
%
...
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''CHEB_SET - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Illegal value of NORDER = ''','norder');
[writeErrFlag]=writeFmt(1,['%c'],'''  Legal values are 1 through 7, and 9.''');
warning(['stop encountered in original fortran code  ',char(10),';']);
return
end;
...
function [norder, xtab, weight]=cheb_to_set( norder, xtab, weight ,varargin);
%*******************************************************************************
%
...
function [norder, xtab, weight]=cheb_tc_set( norder, xtab, weight ,varargin);
%*******************************************************************************
%
...
if( norder < 2 );
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''CHEB_TC_SET - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c'],'''  NORDER must be at least 2.''');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  The input value was NORDER = ''','norder');
warning(['stop encountered in original fortran code  ',char(10),';']);
return
end;
for i = 1: norder;
...
function [norder, xtab, weight]=cheb_u_set( norder, xtab, weight ,varargin);
%*******************************************************************************
%
...
function [n, a]=dvec_reverse( n, a ,varargin);
%*******************************************************************************
%
...
function [gammaresult, x ]=gamma( x ,varargin);
%*******************************************************************************
%
...
gammaresult = 0.0d+00;
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''GAMMA - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c'],'''  Input argument X <= 0.''');
warning(['stop encountered in original fortran code  ',char(10),';']);
csnil=dbstack(1); csnil=csnil(1).name(1)~='@';
if csnil&&~isempty(inputname(1)), assignin('caller','FUntemp',x); evalin('caller',[inputname(1),'=FUntemp;']); end
return
...
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''GAMMA - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c'],'''  Input argument 70 <= X.''');
warning(['stop encountered in original fortran code  ',char(10),';']);
csnil=dbstack(1); csnil=csnil(1).name(1)~='@';
if csnil&&~isempty(inputname(1)), assignin('caller','FUntemp',x); evalin('caller',[inputname(1),'=FUntemp;']); end
return
...
function [norder, xtab, weight]=hermite_com( norder, xtab, weight ,varargin);
%*******************************************************************************
%
...
function [p2, dp2, p1, x, norder]=hermite_recur( p2, dp2, p1, x, norder ,varargin);
%*******************************************************************************
%
...
function [x, norder, dp2, p1]=hermite_root( x, norder, dp2, p1 ,varargin);
%*******************************************************************************
%
...
%    Output, real ( kind = 8 ) P1, the value of H(NORDER-1,X).
%
persistent d eps_ml i maxstep p2 ; 

 if isempty(d), d=0; end;
 if isempty(eps_ml), eps_ml = 1.0d-12; end;
 if isempty(i), i=0; end;
...
d = p2 ./ dp2;
x = x - d;
if( abs( d ) <= eps_ml .*( abs( x ) + 1.0d+00 ) );
return;
end;
end; i = fix(maxstep+1);
return;
end
function [norder, xtab, weight]=hermite_set( norder, xtab, weight ,varargin);
%*******************************************************************************
%
...
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''HERMITE_SET - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Illegal value of NORDER = ''','norder');
[writeErrFlag]=writeFmt(1,['%c'],'''  Legal values are 1 to 20,''');
[writeErrFlag]=writeFmt(1,['%c'],'''  30, 32, 40, 50, 60 and 64.''');
warning(['stop encountered in original fortran code  ',char(10),';']);
return
end;
return;
end
function [norder, xtab, weight, alpha_ml, beta]=jacobi_com( norder, xtab, weight, alpha_ml, beta ,varargin);
%*******************************************************************************
%
...
%
for i = 1: norder;
if( alpha_ml + beta == 0.0d+00 || beta - alpha_ml == 0.0d+00);
b(i) = 0.0d+00;
else;
b(i) =( alpha_ml + beta ) .*( beta - alpha_ml ) ./(( alpha_ml + beta + real( 2 .* i) ).*( alpha_ml + beta + real( 2 .* i - 2) ) );
end;
if( i == 1 );
c(i) = 0.0d+00;
else;
c(i) = 4.0d+00 .* real( i - 1).*( alpha_ml + real( i - 1) ).*( beta + real( i - 1) ).*( alpha_ml + beta + real( i - 1) ) ./(( alpha_ml + beta + real( 2 .* i - 1) ).*( alpha_ml + beta + real( 2 .* i - 2) ).^2.*( alpha_ml + beta + real( 2 .* i - 3) ) );
end;
end; i = fix(norder+1);
delta = exp( log_gamma( alpha_ml + 1.0d+00 ) + log_gamma( beta + 1.0d+00)+ log_gamma( alpha_ml + beta + 2.0d+00 ) );
cc = delta .* 2.0d+00.^( alpha_ml + beta + 1.0d+00 ) .* prod( c([2:norder]) );
for i = 1: norder;
if( i == 1 );
an = alpha_ml ./ real( norder);
bn = beta ./ real( norder);
r1 =( 1.0d+00 + alpha_ml ).*( 2.78d+00 ./( 4.0d+00+ real( norder.^2) )+ 0.768d+00 .* an ./ real( norder) );
r2 = 1.0d+00 + 1.48d+00 .* an + 0.96d+00 .* bn+ 0.452d+00 .* an.^2 + 0.83d+00 .* an .* bn;
x =( r2 - r1 ) ./ r2;
elseif( i == 2 ) ;
r1 =( 4.1d+00 + alpha_ml ) ./(( 1.0d+00 + alpha_ml ) .*( 1.0d+00 + 0.156d+00 .* alpha_ml ) );
r2 = 1.0d+00 + 0.06d+00 .*( real( norder) - 8.0d+00 ) .*( 1.0d+00 + 0.12d+00 .* alpha_ml ) ./ real( norder);
r3 = 1.0d+00 + 0.012d+00 .* beta .*( 1.0d+00 + 0.25d+00 .* abs( alpha_ml ) ) ./ real( norder);
x = x - r1 .* r2 .* r3 .*( 1.0d+00 - x );
elseif( i == 3 ) ;
r1 =( 1.67d+00 + 0.28d+00 .* alpha_ml ) ./( 1.0d+00 + 0.37d+00 .* alpha_ml );
...
r3 = 1.0d+00 ./( 1.0d+00 + 20.0d+00 .* alpha_ml ./(( 7.5d+00 + alpha_ml ) .*real( norder.^2) ) );
...
r3 = 1.0d+00 ./( 1.0d+00 + 8.0d+00 .* alpha_ml ./(( 6.28d+00 + alpha_ml ) .* real( norder.^2) ) );
x = x + r1 .* r2 .* r3 .*( x - xtab(i-2) );
end;
[ x, norder, alpha_ml, beta, dp2, p1, b, c ]=jacobi_root( x, norder, alpha_ml, beta, dp2, p1, b, c );
xtab(i) = x;
weight(i) = cc ./( dp2 .* p1 );
end; i = fix(norder+1);
%
...
function [p2, dp2, p1, x, norder, alpha_ml, beta, b, c]=jacobi_recur( p2, dp2, p1, x, norder, alpha_ml, beta, b, c ,varargin);
%*******************************************************************************
%
...
p1 = 1.0d+00;
dp1 = 0.0d+00;
p2 = x +( alpha_ml - beta ) ./( alpha_ml + beta + 2.0d+00 );
dp2 = 1.0d+00;
for i = 2: norder;
p0 = p1;
dp0 = dp1;
...
function [x, norder, alpha_ml, beta, dp2, p1, b, c]=jacobi_root( x, norder, alpha_ml, beta, dp2, p1, b, c ,varargin);
%*******************************************************************************
%
...
eps_ml = eps;
for i = 1: maxstep;
[ p2, dp2, p1, x, norder, alpha_ml, beta, b, c ]=jacobi_recur( p2, dp2, p1, x, norder, alpha_ml, beta, b, c );
d = p2 ./ dp2;
x = x - d;
if( abs( d ) <= eps_ml .*( abs( x ) + 1.0d+00 ) );
return;
...
function [norder, xtab, weight]=kronrod_set( norder, xtab, weight ,varargin);
%*******************************************************************************
%
...
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''KRONROD_SET - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Illegal value of NORDER = ''','norder');
[writeErrFlag]=writeFmt(1,['%c'],'''  Legal values are 15, 21, 31 or 41.''');
warning(['stop encountered in original fortran code  ',char(10),';']);
return
end;
return;
end
function [norder, xtab, weight, alpha_ml]=laguerre_com( norder, xtab, weight, alpha_ml ,varargin);
%*******************************************************************************
%
...
%
for i = 1: norder;
b(i) =( alpha_ml + real( 2 .* i - 1) );
end; i = fix(norder+1);
for i = 1: norder;
c(i) = real( i - 1) .*( alpha_ml + real( i - 1) );
end; i = fix(norder+1);
cc = gamma( alpha_ml + 1.0d+00 ) .* prod( c([2:norder]) );
for i = 1: norder;
%
%  Compute an estimate for the root.
%
if( i == 1 );
x =( 1.0d+00 + alpha_ml ) .*( 3.0d+00+ 0.92 .* alpha_ml ) ./( 1.0d+00 + 2.4d+00 .* real( norder) + 1.8d+00 .* alpha_ml );
elseif( i == 2 ) ;
x = x +( 15.0d+00 + 6.25d+00 .* alpha_ml ) ./( 1.0d+00 + 0.9d+00 .* alpha_ml + 2.5d+00 .* real( norder) );
else;
r1 =( 1.0d+00 + 2.55d+00 .* real( i - 2) )./( 1.9d+00 .* real( i - 2) );
r2 = 1.26d+00 .* real( i - 2) .* alpha_ml ./( 1.0d+00 + 3.5d+00 .* real( i - 2) );
ratio =( r1 + r2 ) ./( 1.0d+00 + 0.3d+00 .* alpha_ml );
x = x + ratio .*( x - xtab(i-2) );
end;
%
%  Use iteration to find the root.
%
[ x, norder, alpha_ml, dp2, p1, b, c ]=laguerre_root( x, norder, alpha_ml, dp2, p1, b, c );
%
...
function [p2, dp2, p1, x, norder, alpha_ml, b, c]=laguerre_recur( p2, dp2, p1, x, norder, alpha_ml, b, c ,varargin);
%*******************************************************************************
%
...
function [x, norder, alpha_ml, dp2, p1, b, c]=laguerre_root( x, norder, alpha_ml, dp2, p1, b, c ,varargin);
%*******************************************************************************
%
...
eps_ml = eps;
for i = 1: maxstep;
[ p2, dp2, p1, x, norder, alpha_ml, b, c ]=laguerre_recur( p2, dp2, p1, x, norder, alpha_ml, b, c );
d = p2 ./ dp2;
x = x - d;
if( abs( d ) <= eps_ml .*( abs( x ) + 1.0d+00 ) );
return;
...
function [norder, xtab, weight]=laguerre_set( norder, xtab, weight ,varargin);
%*******************************************************************************
%
...
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''LAGUERRE_SET - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Illegal value of NORDER = ''','norder');
[writeErrFlag]=writeFmt(1,['%c'],'''  Legal values are 1 to 20.''');
warning(['stop encountered in original fortran code  ',char(10),';']);
return
...
function [func, a, norder, xtab, weight, result]=laguerre_sum( func, a, norder, xtab, weight, result ,varargin);
%*******************************************************************************
%
...
if( norder < 1 );
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''LAGUERRE_SUM - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Nonpositive NORDER = ''','norder');
warning(['stop encountered in original fortran code  ',char(10),';']);
return
end;
result = 0.0d+00;
...
function [norder, xtab, weight]=legendre_com( norder, xtab, weight ,varargin);
%*******************************************************************************
%
...
if( norder < 1 );
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''LEGENDRE_COM - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Illegal value of NORDER = ''','norder');
warning(['stop encountered in original fortran code  ',char(10),';']);
return
end;
...
function [p2, dp2, p1, x, norder]=legendre_recur( p2, dp2, p1, x, norder ,varargin);
%*******************************************************************************
%
...
function [norder, xtab, weight]=legendre_set_cos( norder, xtab, weight ,varargin);
%*******************************************************************************
%
...
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''LEGENDRE_SET_COS - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Illegal value of NORDER = ''','norder');
warning(['stop encountered in original fortran code  ',char(10),';']);
return
end;
...
function [norder, xtab, weight]=legendre_set_cos2( norder, xtab, weight ,varargin);
%*******************************************************************************
%
...
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''LEGENDRE_SET_COS2 - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Illegal value of NORDER = ''','norder');
warning(['stop encountered in original fortran code  ',char(10),';']);
return
end;
...
function [norder, xtab, weight]=legendre_set_log( norder, xtab, weight ,varargin);
%*******************************************************************************
%
...
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''LEGENDRE_SET_LOG - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Illegal value of NORDER = ''','norder');
warning(['stop encountered in original fortran code  ',char(10),';']);
return
end;
...
function [norder, xtab, weight]=legendre_set_sqrtx_01( norder, xtab, weight ,varargin);
%*******************************************************************************
%
...
function [norder, xtab, weight]=legendre_set_sqrtx2_01( norder, xtab, weight ,varargin);
%*******************************************************************************
%
...
function [norder, xtab, weight]=legendre_set_x0_01( norder, xtab, weight ,varargin);
%*******************************************************************************
%
...
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''LEGENDRE_SET_X0_01 - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Illegal value of NORDER = ''','norder');
warning(['stop encountered in original fortran code  ',char(10),';']);
return
end;
...
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Illegal input value of NORDER = ''','norder');
warning(['stop encountered in original fortran code  ',char(10),';']);
return
end;
return;
end
function [norder, xtab, weight]=legendre_set_x1_01( norder, xtab, weight ,varargin);
%*******************************************************************************
%
...
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''LEGENDRE_SET_X1_01 - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Illegal value of NORDER = ''','norder');
warning(['stop encountered in original fortran code  ',char(10),';']);
return
end;
...
function [norder, xtab, weight]=legendre_set_x2_01( norder, xtab, weight ,varargin);
%*******************************************************************************
%
...
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''LEGENDRE_SET_X2_01 - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Illegal value of NORDER = ''','norder');
warning(['stop encountered in original fortran code  ',char(10),';']);
return
end;
...
function [norder, xtab, weight]=lobatto_set( norder, xtab, weight ,varargin);
%*******************************************************************************
%
...
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''LOBATTO_SET - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Illegal value of NORDER = ''','norder');
[writeErrFlag]=writeFmt(1,['%c'],'''  Legal values are between 2 and 20.''');
warning(['stop encountered in original fortran code  ',char(10),';']);
return
end;
return;
end
function [log_gammaresult, x ]=log_gamma( x ,varargin);
%*******************************************************************************
%
...
if( p <= 0.0d+00 );
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''LOG_GAMMA - fatal error!''');
warning(['stop encountered in original fortran code  ',char(10),';']);
csnil=dbstack(1); csnil=csnil(1).name(1)~='@';
if csnil&&~isempty(inputname(1)), assignin('caller','FUntemp',x); evalin('caller',[inputname(1),'=FUntemp;']); end
return
...
function [norder, xtab, weight]=moulton_set( norder, xtab, weight ,varargin);
%*******************************************************************************
%
...
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''MOULTON_SET - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Illegal value of NORDER = ''','norder');
[writeErrFlag]=writeFmt(1,['%c'],'''  Legal values are 1 through 10.''');
warning(['stop encountered in original fortran code  ',char(10),';']);
return
end;
for i = 1: norder;
...
function [norder, a, b, xtab, weight]=nc_com( norder, a, b, xtab, weight ,varargin);
%*******************************************************************************
%
...
function [norder, xtab, weight]=ncc_com( norder, xtab, weight ,varargin);
%*******************************************************************************
%
...
function [norder, xtab, weight]=ncc_set( norder, xtab, weight ,varargin);
%*******************************************************************************
%
...
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''NCC_SET - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Illegal value of NORDER = ''','norder');
[writeErrFlag]=writeFmt(1,['%c'],'''  Legal values are 2 through 20.''');
warning(['stop encountered in original fortran code  ',char(10),';']);
return
end;
%
...
function [norder, xtab, weight]=nco_com( norder, xtab, weight ,varargin);
%*******************************************************************************
%
...
function [norder, xtab, weight]=nco_set( norder, xtab, weight ,varargin);
%*******************************************************************************
%
...
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''NCO_SET - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Illegal value of NORDER = ''','norder');
[writeErrFlag]=writeFmt(1,['%c'],'''  Legal values are 1 to 7, and 9.''');
warning(['stop encountered in original fortran code  ',char(10),';']);
return
end;
%
...
function [norder, xtab, weight]=radau_set( norder, xtab, weight ,varargin);
%*******************************************************************************
%
...
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''RADAU_SET - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Illegal value of NORDER = ''','norder');
[writeErrFlag]=writeFmt(1,['%c'],'''  Legal values are 1 to 15.''');
warning(['stop encountered in original fortran code  ',char(10),';']);
return
end;
return;
...
function [func, norder, xtab, weight, result]=summer( func, norder, xtab, weight, result ,varargin);
%*******************************************************************************
%
...
if( norder < 1 );
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''SUMMER - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c'],'''  NORDER must be at least 1.''');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  The input value was NORDER = ''','norder');
warning(['stop encountered in original fortran code  ',char(10),';']);
return
end;
...
function [func, norderg, weightg, resultg, norderk, xtabk,weightk, resultk]=summer_gk( func, norderg, weightg, resultg, norderk, xtabk,weightk, resultk ,varargin);
%*******************************************************************************
%
...
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''SUMMER_GK - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c'],'''  NORDERK must equal 2 * NORDERG + 1.''');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  The input value was NORDERG = ''','norderg');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  The input value was NORDERK = ''','norderk');
warning(['stop encountered in original fortran code  ',char(10),';']);
return
end;
resultg = 0.0d+00;
...
function [func, a, b, nsub, norder, xlo, xhi, xtab, weight, result]=sum_sub( func, a, b, nsub, norder, xlo, xhi, xtab, weight, result ,varargin);
%*******************************************************************************
%
...
if( norder < 1 );
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''SUM_SUB - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Nonpositive value of NORDER = ''','norder');
warning(['stop encountered in original fortran code  ',char(10),';']);
return
end;
if( nsub < 1 );
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''SUM_SUB - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  Nonpositive value of NSUB = ''','nsub');
warning(['stop encountered in original fortran code  ',char(10),';']);
return
end;
if( xlo == xhi );
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''SUM_SUB - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c'],'''  XLO = XHI.''');
warning(['stop encountered in original fortran code  ',char(10),';']);
return
end;
volume = 0.0d+00;
...
function [func, a, b, nsub, norderg, weightg, resultg, norderk,xtabk, weightk, resultk, error]=sum_sub_gk( func, a, b, nsub, norderg, weightg, resultg, norderk,xtabk, weightk, resultk, error ,varargin);
%*******************************************************************************
%
...
if( norderk ~= 2 .* norderg + 1 );
[writeErrFlag]=writeFmt(1,['%c'],''' ''');
[writeErrFlag]=writeFmt(1,['%c'],'''SUM_SUB_GK - Fatal error!''');
[writeErrFlag]=writeFmt(1,['%c'],'''  NORDERK must equal 2 * NORDERG + 1.''');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  The input value was NORDERG = ''','norderg');
[writeErrFlag]=writeFmt(1,['%c','%6d'],'''  The input value was NORDERK = ''','norderk');
warning(['stop encountered in original fortran code  ',char(10),';']);
