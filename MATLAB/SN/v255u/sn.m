...
if option == 1
fprintf('\n\t 1 --> Original dataset aparm(3) = 1 (avg LL & RR)\n\n')
filename = '/Users/satellite/Dropbox/bin/MATLAB/SN/v255u/aparm3is1_head.txt';
end
if option == 2
fprintf('\n\t 2 --> Original runfile parameters\n\n')
filename = '/Users/satellite/Dropbox/bin/MATLAB/SN/v255u/oriRunfil_head.txt';
end
...
month =   11 * ones(length(dayx),1);
day   =   19 * ones(length(dayx),1);
day(find(dayx)) = 20;
