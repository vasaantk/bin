...
fprintf('\n\t 14 --> Original runfile parameters \n\n')
beginHarvest = 0;
end
...
if option == 1
fprintf('\n\t 1 --> Original dataset aparm(3) = 0 \n\n')
filename = '/Users/satellite/Dropbox/bin/MATLAB/SN/v255t/aparm3is0_head.txt';
end
if option == 2
fprintf('\n\t 2 --> Original dataset aparm(3) = 1 (avg LL & RR)\n\n')
filename = '/Users/satellite/Dropbox/bin/MATLAB/SN/v255t/aparm3is1_head.txt';
end
if option == 3
fprintf('\n\t 3 --> SPLAT LL2RR (identical to original LL)\n\n')
filename = '/Users/satellite/Dropbox/bin/MATLAB/SN/v255t/ll2rr_head0000.txt';
end
if option == 4
fprintf('\n\t 4 --> SPLAT RR\n\n')
filename = '/Users/satellite/Dropbox/bin/MATLAB/SN/v255t/rr_head0000000.txt';
end
if option == 5
fprintf('\n\t 5 --> LL2RR + RR + aparm(3) = 0\n\n')
filename = '/Users/satellite/Dropbox/bin/MATLAB/SN/v255t/glprm3is0_head.txt';
end
if option == 6
fprintf('\n\t 6 --> LL2RR + RR + aparm(3) = 1\n\n')
filename = '/Users/satellite/Dropbox/bin/MATLAB/SN/v255t/glprm3is1_head.txt';
end
if option == 7
fprintf('\n\t 7 --> Original dataset with IFs 3 & 4 flagged\n\n')
filename = '/Users/satellite/Dropbox/bin/MATLAB/SN/v255t/origFl3n4_head.txt';
end
if option == 8
fprintf('\n\t 8 --> Original dataset with BIF 1 EIF 2\n\n')
filename = '/Users/satellite/Dropbox/bin/MATLAB/SN/v255t/bifeif2_head00.txt';
end
if option == 9
fprintf('\n\t 9 --> LL2RR refant(ATCA)\n\n')
filename = '/Users/satellite/Dropbox/bin/MATLAB/SN/v255t/ll2rrat_head00.txt';
end
if option == 10
fprintf('\n\t 10 --> LL2RR + VBGLU + MSORT with aparm(3) = 0\n\n')
filename = '/Users/satellite/Dropbox/bin/MATLAB/SN/v255t/mstprm3is0head.txt';
end
if option == 11
fprintf('\n\t 11 --> LL2RR + VBGLU + MSORT with aparm(3) = 1\n\n')
filename = '/Users/satellite/Dropbox/bin/MATLAB/SN/v255t/mstprm3is1head.txt';
end
if option == 12
fprintf('\n\t 12 --> LL2RR + VBGLU + MSORT with aparm(3) = 0 & BIF/EIF 1/2\n\n')
filename = '/Users/satellite/Dropbox/bin/MATLAB/SN/v255t/mstbif1to2head.txt';
% If FRING with BIF/EIF 3/4, there are no solutions found at all
end
if option == 13
fprintf('\n\t 13 --> LL2RR + VBGLU + MSORT with aparm(3) = 1 & BIF/EIF 1/2\n\n')
filename = '/Users/satellite/Dropbox/bin/MATLAB/SN/v255t/mtbif1to2n3is1.txt';
end
if option == 14
fprintf('\n\t 14 --> Original runfile parameters \n\n')
filename = '/Users/satellite/Dropbox/bin/MATLAB/SN/v255t/oriRunfil_head.txt';
end
