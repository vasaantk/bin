...
if delim == 'pr'
fprintf('\n       Option:\n')
fprintf('\n\t 1 --> Original dataset aparm(3) = 1 (avg LL & RR)\n\n')
fprintf('\n\t 2 --> SPLAT LL2RR (identical to original LL)\n\n')
fprintf('\n\t 3 --> SPLAT RR\n\n')
fprintf('\n\t 4 --> Original runfile parameters \n\n')
beginHarvest = 0;
end
...
if option == 1
fprintf('\n\t 1 --> Original dataset aparm(3) = 1 (avg LL & RR)\n\n')
filename = '/Users/satellite/Dropbox/bin/MATLAB/SN/v255s/aparm3is1_head.txt';
end
if option == 2
fprintf('\n\t 2 --> SPLAT LL2RR (identical to original LL)\n\n')
filename = '/Users/satellite/Dropbox/bin/MATLAB/SN/v255s/ll2rr_head0000.txt';
end
if option == 3
fprintf('\n\t 3 --> SPLAT RR\n\n')
filename = '/Users/satellite/Dropbox/bin/MATLAB/SN/v255s/rr_head0000000.txt';
end
if option == 4
fprintf('\n\t 4 --> Original runfile parameters\n\n')
filename = '/Users/satellite/Dropbox/bin/MATLAB/SN/v255s/oriRunfil_head.txt';
end
...
month =    6 * ones(length(dayx),1);
day   =   17 * ones(length(dayx),1);
day(find(dayx)) = 18;
