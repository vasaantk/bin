...
# for i in {1,4,6,7,8,9,10} ; do grep " $i " G024.78_EM117K.COMP.PTS | pts2feat.py | sort -nk 3,3 >> output_feature_$i.txt ; done
...
# converted values for comps {1,4,6,7,8,9,10} are sorted according to
# channel (k 3,3) and written to their individual files.
...
# for i in {1,4,6,7,8,9,10} ; do cp polvars_$i.inp polvars.inp ; grep " $i " G024.78_EM117K.COMP.PTS | pts2feat.py | sort -nk 3,3 >> output_feature_$i.txt ; rm polvars.inp ; done
