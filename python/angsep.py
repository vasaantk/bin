...
print("\n Delta RA:  "+string.zfill(repr(hh),2)+':'+string.zfill(repr(mm),2)+':'+'%10.8f, hms format' % ss)

hh   =int(deg)
mm   =int((deg-int(deg))*60)
ss   =((deg-int(deg))*60-mm)*60
print(" Delta RA:  "+string.zfill(repr(hh),2)+':'+string.zfill(repr(mm),2)+':'+'%10.8f, dms format' % ss)
...
print(" Delta RA:  "+string.zfill(repr(hh),2)+':'+string.zfill(repr(mm),2)+':'+'%10.8f, dms format, corrected with cos(declination 1)' % ss)
...
mm   =int((deg-int(deg))*60)
ss   =((deg-int(deg))*60-mm)*60
print(" Delta DEC: "+string.zfill(repr(hh),2)+':'+string.zfill(repr(mm),2)+':'+'%10.8f (dms format)' % ss)
...
print("\n Angular Separation: "+string.zfill(repr(hh),2)+":"+string.zfill(repr(mm),2)+":"+'%10.8f (dms format)' % ss)
print(" Angular Separation: " + str(deg) + " degrees")
