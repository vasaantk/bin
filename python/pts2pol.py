...
if len(usrFile) == 0:
    ...
    print "# calibration from step 15) of 'METH_MASER_PROCEDURE.HELP'. The"
    print "# calculated pixel centroid is within errors of the measured values"
    print "# from JMFIT. The script error scales inversely with flux: complete"
    print "# agreement with strong >~few Jy emission to ~1 pix with <1 Jy"
    print "# emission."
    print ""
    ...
    print "  cenx     = 256.14             # Pixel corresponding to RA  from IMHEAD in AIPS    (float)"
    print "  ceny     = 256.81             # Pixel corresponding to Dec from IMHEAD in AIPS    (float)"
