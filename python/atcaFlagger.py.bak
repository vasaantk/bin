...
# Script to read in a compact array off-source information text file
# and output it in a format compatible with AIPS uvflgs

# Example input: atcaFlagger.py monica.log
